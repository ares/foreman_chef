  ...
  module ForemanChef
    module Client
      class Create < Actions::EntryAction
        ...
        # TODO consult ivan - ma smysl to tu checkovat nebo radeji check v nejakym nad task kterej bude vedet kontext,
        # zda se snazime o regenerovani nebo tvorbu novyho?
        def plan(name, proxy)
          ...
          Rails.logger.debug "CLIENT Unable to communicate with Chef proxy, #{e.message}"
        ...
        # def finalize
        #   # todo - store private key (and possibly other info) or maybe from some above action
        # end
